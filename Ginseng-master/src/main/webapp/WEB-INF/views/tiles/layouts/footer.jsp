		...
		<div class="container">
			...
			<div class="row">
					...
					<div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
							<i class="lnr lnr-envelope"></i><b> Email: </b><a href="mailto:ltphong@gmail.com">ltphong@gmail.com </a>
					</div>
					<div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
	...
	<div class="footer-bottom pb-30">
		<div class="container">
			 ...
			 <div class="copyright-text text-center">                    
				<p>Copyright © 2018 <a target="_blank" href="#">Le Trung Phong. </a> All Rights Reserved.</p>
			 </div>
		</div>
		<!-- Container End -->
	</div>
